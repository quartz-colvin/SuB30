...
- the choice functional analysis for *ib* more clearly explains the fact that Hmong indefinite *ib cov* DPs have a non-specific meaning and they select a random subset from the cover generated by *cov* 
...
- the DP structures are built via standard functional application, we see a micro-case of ***antipresupposition***
...
- not a classifier language, at least in the same way that HMong or Chinese are, so this could be a new way to look at the **cover** concept in natural language 
...
### ***ā*** (plural morpheme) may have a cover-generating property like *cov*
