...
- there is minimal semantic work on Hmong and any previous discussion of classifiers is brief, descriptive, and focused on classifier choice (Bisang 1993). 
...
(3) **Cov** *covers* A if: (Schwarzschild 1996)
...
(5) [[*cov*]]<sup>*M,g*</sup> = λP.λx.x ∈ **Cov**(P)

- Since *cov* doesn’t operate over kinds and instead operates over properties, I assume there is an N operator (following Chierchia 1998) in the denotation to show that P must be a property by the time *cov* combines with the noun, though this operator is not explicitly shown in the following denotations.
...
(7) [[*ib*]]<sup>*M,g*</sup> = λP. *f*<sub>*cf*</sub> (λy.P(y) = 1)
