...
\begin{tikzpicture}
	\node[state] (0) {\textbf{$a$}}; 
	\node[state, right of=0, xshift=2.5cm] (1) {\textbf{$c$}}; 
	\node[state, right of=0, xshift=6cm] (2) {\textbf{$m$}}; 
	\node[state] at (0.5,3) (4) {\textbf{$a \oplus c$}};
	\node[state] at (3.5,3) (6) {\textbf{$a \oplus m$}};
	\node[state] at (6.5,3) (5) {\textbf{$c \oplus m$}};
	\node[state] at (3.5,6) (3) {\textbf{$a \oplus c \oplus m$}};
